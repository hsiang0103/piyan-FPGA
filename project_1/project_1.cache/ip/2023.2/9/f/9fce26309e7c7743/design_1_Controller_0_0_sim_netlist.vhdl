...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  port (
    ...
    ifmap_YID_scan_in : out STD_LOGIC_VECTOR ( 4 downto 0 );
    filter_YID_scan_in : out STD_LOGIC_VECTOR ( 4 downto 0 );
    ipsum_YID_scan_in : out STD_LOGIC_VECTOR ( 4 downto 0 );
    opsum_YID_scan_in : out STD_LOGIC_VECTOR ( 4 downto 0 );
...
begin
  ...
  PE_en(1) <= \<const0>\;
  PE_en(0) <= \<const0>\;
  filter_YID_scan_in(4) <= \<const0>\;
  filter_YID_scan_in(3) <= \<const0>\;
  ...
  ifmap_YID_scan_in(4) <= \<const0>\;
  ifmap_YID_scan_in(3) <= \<const0>\;
  ...
  ipsum_YID_scan_in(4) <= \<const0>\;
  ipsum_YID_scan_in(3) <= \<const0>\;
  ...
  opsum_YID_scan_in(4) <= \<const0>\;
  opsum_YID_scan_in(3) <= \<const0>\;
