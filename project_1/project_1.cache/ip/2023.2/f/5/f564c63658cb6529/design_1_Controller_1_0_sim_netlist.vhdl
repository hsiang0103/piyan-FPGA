...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Controller is
  ...
  attribute SOFT_HLUTNM of \FSM_onehot_cs[2]_i_1\ : label is "soft_lutpair0";
  attribute FSM_ENCODED_STATES : string;
  attribute FSM_ENCODED_STATES of \FSM_onehot_cs_reg[0]\ : label is "s1:010,s2:100,s0:001";
  attribute FSM_ENCODED_STATES of \FSM_onehot_cs_reg[1]\ : label is "s1:010,s2:100,s0:001";
  attribute FSM_ENCODED_STATES of \FSM_onehot_cs_reg[2]\ : label is "s1:010,s2:100,s0:001";
  attribute SOFT_HLUTNM of \filter_XID_scan_in[0]_INST_0\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \filter_XID_scan_in[1]_INST_0\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \filter_XID_scan_in[2]_INST_0\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \filter_XID_scan_in[3]_INST_0\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \filter_XID_scan_in[4]_INST_0\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \ifmap_XID_scan_in[0]_INST_0\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \ifmap_XID_scan_in[1]_INST_0\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \ifmap_XID_scan_in[2]_INST_0\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \ifmap_XID_scan_in[3]_INST_0\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \ifmap_XID_scan_in[4]_INST_0\ : label is "soft_lutpair10";
  ...
  attribute SOFT_HLUTNM of \ipsum_XID_scan_in[2]_INST_0\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \ipsum_XID_scan_in[3]_INST_0\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \ipsum_XID_scan_in[4]_INST_0\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \opsum_XID_scan_in[0]_INST_0\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \opsum_XID_scan_in[1]_INST_0\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \opsum_XID_scan_in[2]_INST_0\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \opsum_XID_scan_in[3]_INST_0\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \opsum_XID_scan_in[4]_INST_0\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of set_XID_INST_0 : label is "soft_lutpair10";
begin
  ack <= \^ack\;
  out0(0) <= \^out0\(0);
...
\FSM_onehot_cs[2]_i_2\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
