...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Controller is
  ...
  attribute SOFT_HLUTNM of \FSM_sequential_cs[0]_i_3\ : label is "soft_lutpair27";
  attribute SOFT_HLUTNM of \FSM_sequential_cs[1]_i_2\ : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of \FSM_sequential_cs[1]_i_3\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \FSM_sequential_cs[2]_i_5\ : label is "soft_lutpair25";
  attribute SOFT_HLUTNM of \FSM_sequential_cs[3]_i_2\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \FSM_sequential_cs[3]_i_3\ : label is "soft_lutpair25";
  ...
  attribute SOFT_HLUTNM of GLB_filter_valid_INST_0 : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of GLB_ifmap_valid_INST_0 : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of GLB_ipsum_valid_INST_0 : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \LN_config_in[0]_INST_0\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \LN_config_in[1]_INST_0\ : label is "soft_lutpair17";
  ...
  attribute SOFT_HLUTNM of \LN_config_in[4]_INST_0\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \PE_config[0]_INST_0\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \PE_config[1]_INST_0\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \PE_config[2]_INST_0\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \PE_config[3]_INST_0\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \PE_config[4]_INST_0\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \PE_config[5]_INST_0\ : label is "soft_lutpair20";
  ...
  attribute SOFT_HLUTNM of \cs[0]_i_3\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \cs[1]_i_2\ : label is "soft_lutpair26";
  attribute SOFT_HLUTNM of \cs[2]_i_2\ : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of \cs[3]_i_5\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \cs[3]_i_6\ : label is "soft_lutpair27";
  attribute SOFT_HLUTNM of \cs[3]_i_7\ : label is "soft_lutpair26";
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  port (
    ...
    tag_X : in STD_LOGIC_VECTOR ( 31 downto 0 );
    tag_Y : in STD_LOGIC_VECTOR ( 31 downto 0 );
    cpu_data : in STD_LOGIC_VECTOR ( 31 downto 0 );
    set_XID : out STD_LOGIC;
    ifmap_XID_scan_in : out STD_LOGIC_VECTOR ( 4 downto 0 );
    filter_XID_scan_in : out STD_LOGIC_VECTOR ( 4 downto 0 );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  signal \^tag_x\ : STD_LOGIC_VECTOR ( 31 downto 0 );
  signal \^tag_y\ : STD_LOGIC_VECTOR ( 31 downto 0 );
...
begin
  ...
  \^tag_x\(26 downto 24) <= tag_X(26 downto 24);
  \^tag_x\(18 downto 16) <= tag_X(18 downto 16);
  \^tag_x\(10 downto 8) <= tag_X(10 downto 8);
  \^tag_x\(2 downto 0) <= tag_X(2 downto 0);
  \^tag_y\(26 downto 24) <= tag_Y(26 downto 24);
  \^tag_y\(18 downto 16) <= tag_Y(18 downto 16);
  \^tag_y\(10 downto 8) <= tag_Y(10 downto 8);
  \^tag_y\(2 downto 0) <= tag_Y(2 downto 0);
  acc_ctrl(31) <= \<const0>\;
  acc_ctrl(30) <= \<const0>\;
  acc_ctrl(29) <= \<const0>\;
  acc_ctrl(28) <= \<const0>\;
  ...
  filter_tag_X(2 downto 0) <= \^tag_y\(2 downto 0);
  filter_tag_Y(2 downto 0) <= \^tag_x\(2 downto 0);
  ifmap_tag_X(4) <= \<const0>\;
  ifmap_tag_X(3) <= \<const0>\;
  ifmap_tag_X(2 downto 0) <= \^tag_y\(10 downto 8);
  ifmap_tag_Y(2 downto 0) <= \^tag_x\(10 downto 8);
  ipsum_tag_X(4) <= \<const0>\;
  ipsum_tag_X(3) <= \<const0>\;
  ipsum_tag_X(2 downto 0) <= \^tag_y\(18 downto 16);
  ipsum_tag_Y(2 downto 0) <= \^tag_x\(18 downto 16);
  opsum_tag_X(4) <= \<const0>\;
  opsum_tag_X(3) <= \<const0>\;
  opsum_tag_X(2 downto 0) <= \^tag_y\(26 downto 24);
  opsum_tag_Y(2 downto 0) <= \^tag_x\(26 downto 24);
